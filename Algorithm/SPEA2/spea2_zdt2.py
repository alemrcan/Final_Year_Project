...
# Calling SPEA-2 Function for ZDT2
spea_2_zdt2 = strength_pareto_evolutionary_algorithm_2(population_size=100, archive_size=100, mutation_rate=0.02, min_values=[0]*30, max_values=[1]*30, list_of_functions=[f1_zdt2, f2_zdt2], generations=1000, mu=1, eta=1)

# Store Function 1 and 2 values
func_1_values = spea_2_zdt2[:,-2]
func_2_values = spea_2_zdt2[:,-1]

# Save data to a DataFrame and export to an Excel file
df = pd.DataFrame({'Function 1': func_1_values, 'Function 2': func_2_values})
file_path = "SPEA2_ZDT2_results.xlsx"
df.to_excel(file_path, index=False)

print(f"Data has been stored in: {file_path}")

# Plotting the ZDT2 Pareto Front
