...
# Load data
nsga2_df = load_and_clean('NSGA2_ZDT4_results.xlsx')
spea2_df = load_and_clean('SPEA2_ZDT4_results.xlsx')
new_df = load_and_clean('MODBO_ZDT4_results.xlsx')
...
# Labeling
plt.title('Comparison of NSGA-II, SPEA2, and MODBO on ZDT4')
plt.xlabel('f1(x)')
plt.ylabel('f2(x)')
plt.legend()
plt.grid(True)
