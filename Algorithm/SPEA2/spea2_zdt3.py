...
# Calling SPEA-2 Function for ZDT3
spea_2_zdt3 = strength_pareto_evolutionary_algorithm_2(population_size=100, archive_size=100, mutation_rate=0.02, min_values=[0]*30, max_values=[1]*30, list_of_functions=[f1_zdt3, f2_zdt3], generations=1000, mu=1, eta=1)

# Store Function 1 and 2 values
func_1_values = spea_2_zdt3[:,-2]
func_2_values = spea_2_zdt3[:,-1]

# Save data to a DataFrame and export to an Excel file
df = pd.DataFrame({'Function 1': func_1_values, 'Function 2': func_2_values})
file_path = "SPEA2_ZDT3_results.xlsx"
df.to_excel(file_path, index=False)

print(f"Data has been stored in: {file_path}")

# Plotting the ZDT3 Pareto Front
